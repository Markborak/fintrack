...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (shopNowBtn) {
    shopNowBtn.addEventListener('click', function() {
      ...
      alert('This would navigate to the products page in a complete implementation');
    });
  }
  ...
  addToCartButtons.forEach(button => {
    button.addEventListener('click', function() {
      ...
      alert('Product added to cart (this would be implemented in a complete e-commerce site)');
    });
  });
});