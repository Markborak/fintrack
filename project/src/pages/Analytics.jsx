...
const Analytics = () => {
  const { transactions, getMonthlyData, getTransactionsByCategory, loading } = useTransactions();
    ...
    <div>
      <div className="transactions-header">
        ...
        <div className="chart-filters">
          ...
          <button 
            className={`btn ${timeframe === 'quarter' ? 'btn-primary' : 'btn-outline'}`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <div className="card">
          ...
          <p className="text-2xl font-bold text-red-500">
            {Object.entries(getTransactionsByCategory()).sort((a, b) => b[1] - a[1])[0]?.[0] || 'N/A'}
          </p>
          <p className="text-gray-500">
            {formatCurrency(Object.entries(getTransactionsByCategory()).sort((a, b) => b[1] - a[1])[0]?.[1] || 0)}
          </p>
        </div>
        
        <div className="card">
          <h3 className="text-lg font-semibold mb-2">Average Monthly Expense</h3>
        ...
        <div className="card">
          ...
          <p className="text-2xl font-bold text-green-500">
            {(() => {
              ...
              return income ? `${Math.round((1 - expenses / income) * 100)}%` : 'N/A';
            })()}
          </p>
        </div>
      </div>
