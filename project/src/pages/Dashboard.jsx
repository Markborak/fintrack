      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className={`stat-change ${stats.balance >= 0 ? 'positive' : 'negative'}`}>
            ...
            {Math.abs(stats.balance / (stats.totalIncome || 1) * 100).toFixed(1)}% of total income
          </div>
        </div>
        <div className="stat-card">
          ...
          <div className="stat-change positive">
            <FiArrowUp />
            {((stats.monthlyIncome / (stats.totalIncome || 1)) * 100).toFixed(1)}% of total
          </div>
        </div>
        <div className="stat-card">
          ...
          <div className="stat-change negative">
            <FiArrowDown />
            {((stats.monthlyExpenses / (stats.totalExpenses || 1)) * 100).toFixed(1)}% of total
          </div>
        </div>
        <div className="stat-card">
          ...
          <div className="stat-value">
            {stats.monthlyIncome ? 
              ((1 - stats.monthlyExpenses / stats.monthlyIncome) * 100).toFixed(1) : 0}%
          </div>
          <div className={`stat-change ${stats.monthlyIncome > stats.monthlyExpenses ? 'positive' : 'negative'}`}>
            {stats.monthlyIncome > stats.monthlyExpenses ? <FiArrowUp /> : <FiArrowDown />}
            Monthly savings
          </div>
        </div>
      </div>
      ...
      <div className="recent-transactions">
        <div className="section-header">
          ...
          <div className="flex gap-2">
            ...
            <Link to="/transactions" className="btn-outline flex items-center gap-2">
